...
class OutputView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final currentSuggestions = isAdmin 
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: const Center(child: Text("Awaiting input...", style: TextStyle(color: Colors.white54, fontSize: 18))),
                            ),
                          ),
                          ...
                          Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: IconButton(icon: const Icon(Icons.mic_none, color: Colors.white70), onPressed: () {}),
                                suffixIcon: Row(
                                  ...
                                  children: [
                                    Tooltip(
                                      ...
                                      textStyle: const TextStyle(color: Colors.amberAccent, fontSize: 12),
                                      child: PopupMenuButton<String>(
                                        ...
                                        onSelected: (String value) {
                                          print("Demo selected: $value");
                                        },
                                        itemBuilder: (BuildContext context) {
                                          final suggestions = ["Can I help you find a specific size?", "Would you like to see our new arrivals?", "Let me check the back for you.", "Your total comes to..."];
                                          return suggestions.map((String choice) {
                                            return PopupMenuItem<String>(value: choice, child: Text(choice, style: const TextStyle(color: Colors.white70)));
                                          }).toList();
                                        },
                                      ),
                                    ),
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                                  ...
                                  return Padding(
                                    ...
                                    child: ElevatedButton(
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor: Colors.white.withOpacity(0.05), foregroundColor: Colors.white70,
                        ...
                        const SizedBox(height: 16),
                        isAdmin ? _buildAdminSettingsRow(context) : const SizedBox(height: 64),
                      ],
                    ),
                  ),
                ],
